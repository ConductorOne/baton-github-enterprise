...
ifeq ($(GOOS),windows)
OUTPUT_PATH = ${BUILD_DIR}/baton-github-enterprise.exe

else
OUTPUT_PATH = ${BUILD_DIR}/baton-github-enterprise
endif
...
build: $(GENERATED_CONF)
	go build ${BUILD_TAGS} -o ${OUTPUT_PATH} ./cmd/baton-github-enterprise
